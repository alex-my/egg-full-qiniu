...
class FullQiniu {
  ...
  async _UPLOAD(key, file, style) {
    ...
    return new Promise((resolved, reject) => {
      formUploader[style](token, key, file, putExtra, (err, respBody, respInfo) => {
        ...
        //   "headers": {
        //     "server": "openresty",
        //     "date": "Fri, 30 Nov 2018 08:22:00 GMT",
        ...
        //     "x-log": "body;0s.ph;0s.put.in;0XXXXX",
        //     "x-reqid": "XXXXX",
        //     "x-svr": "UP",
        //     "x-via": "vdn-hbxy-tel-1-3"
        //   },
        //   "size": 103,
        //   "aborted": false,
        //   "rt": 529,
        ...
        //   "data": {
        //     "hash": "FhfDDtTkyR02fXq87bdlvJd-XXXX",
        //     "key": "02128b30-f479-11e8-a178-cdf1d17ada6dXXXX.jpg"
        //   },
        //   "requestUrls": ["http://upload.qiniup.com"],
        //   "timing": null,
        //   "remoteAddress": "111.255.255.255",
        //   "remotePort": 80
        // }
  ...
  /**
   * CDN 获取指定域名流量
   * @param {*} startDate: 起始日期 2018-01-01
   * @param {*} endDate: 结束日期 2018-01-02
   * @param {*} domains: 待查询的域名集合
   * @return {Object}:
   */
